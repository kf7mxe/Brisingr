package com.kf7mxe.brisingr.sdk
...
class LiveApi(val fetcher: Fetcher) : Api {
	...
	override val appRelease = com.lightningkite.lightningserver.typed.LiveClientModelRestEndpoints(fetcher, "app-releases", com.kf7mxe.brisingr.AppRelease.serializer(), kotlin.uuid.Uuid.serializer())

	override val user = com.lightningkite.lightningserver.typed.LiveClientModelRestEndpoints(fetcher, "users", com.kf7mxe.brisingr.User.serializer(), kotlin.uuid.Uuid.serializer())

	inner class LiveUserAuthApi : Api.UserAuthApi, com.lightningkite.lightningserver.typed.ClientModelRestEndpoints<com.lightningkite.lightningserver.sessions.Session<com.kf7mxe.brisingr.User, kotlin.uuid.Uuid>, kotlin.uuid.Uuid> by com.lightningkite.lightningserver.typed.LiveClientModelRestEndpoints(fetcher, "auth/user/sessions", com.lightningkite.lightningserver.sessions.Session.serializer(com.kf7mxe.brisingr.User.serializer(), kotlin.uuid.Uuid.serializer()), kotlin.uuid.Uuid.serializer()), com.lightningkite.lightningserver.sessions.proofs.AuthClientEndpoints<com.kf7mxe.brisingr.User, kotlin.uuid.Uuid> by com.lightningkite.lightningserver.sessions.proofs.LiveAuthClientEndpoints(fetcher, "auth/user", com.kf7mxe.brisingr.User.serializer(), kotlin.uuid.Uuid.serializer()) {
	...
	inner class LiveFcmTokenApi : Api.FcmTokenApi, com.lightningkite.lightningserver.typed.ClientModelRestEndpoints<com.kf7mxe.brisingr.FcmToken, kotlin.String> by com.lightningkite.lightningserver.typed.LiveClientModelRestEndpoints(fetcher, "fcmTokens", com.kf7mxe.brisingr.FcmToken.serializer(), kotlin.String.serializer()) {
		override suspend fun registerToken(input: kotlin.String): com.lightningkite.services.database.EntryChange<com.kf7mxe.brisingr.FcmToken> =
			fetcher("fcmTokens/register", HttpMethod.POST, kotlin.String.serializer(), input, com.lightningkite.services.database.EntryChange.serializer(com.kf7mxe.brisingr.FcmToken.serializer()))
