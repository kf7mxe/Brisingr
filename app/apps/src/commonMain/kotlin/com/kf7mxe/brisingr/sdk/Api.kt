...
interface Api {
	...
	val appRelease: com.lightningkite.lightningserver.typed.ClientModelRestEndpoints<com.kf7mxe.brisingr.AppRelease, kotlin.uuid.Uuid>

	val user: com.lightningkite.lightningserver.typed.ClientModelRestEndpoints<com.kf7mxe.brisingr.User, kotlin.uuid.Uuid>

	interface UserAuthApi : com.lightningkite.lightningserver.typed.ClientModelRestEndpoints<com.lightningkite.lightningserver.sessions.Session<com.kf7mxe.brisingr.User, kotlin.uuid.Uuid>, kotlin.uuid.Uuid>, com.lightningkite.lightningserver.sessions.proofs.AuthClientEndpoints<com.kf7mxe.brisingr.User, kotlin.uuid.Uuid> {
	...
	interface FcmTokenApi : com.lightningkite.lightningserver.typed.ClientModelRestEndpoints<com.kf7mxe.brisingr.FcmToken, kotlin.String> {
		/**
		 * Register Token
		 * 
		 * **Auth Requirements:** User with root access
		 * */
		suspend fun registerToken(input: kotlin.String): com.lightningkite.services.database.EntryChange<com.kf7mxe.brisingr.FcmToken>
		/**
